...
public class ClockWorkerServer {
    
    static String addressName = "localhost";
    static int portNum = 8081;
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            System.out.println("Worker : (localhost, 8081) connected to main server ");
        ...
        try {
            ...
            if (str.equalsIgnoreCase("SERVER")) {
                ...
                for(int i=0; i<activeProcess; i++){
                    ...
                    if((processAddress.equalsIgnoreCase(ClockWorkerServer.addressName)) && (ClockWorkerServer.portNum == processPort)){
                        continue;
                    }
                    ...
                    sendTime = ClockWorkerServer.time;
                    dosC.writeInt(sendTime);
                    dosC.writeUTF("Hi_From_wrkr_8081");
                    ClockWorkerServer.time = ClockWorkerServer.time +1;
                    
                    takeTime = disC.readInt();
                    String msg = disC.readUTF();
                    ClockWorkerServer.time = ClockWorkerServer.time +1;
                    //receiveTime = calendar.getTimeInMillis()+ClockWorkerServer.timeDifference;
                    receiveTime = ClockWorkerServer.time;
                    
                    System.out.println(" ");
                    System.out.println("send : Hi_From_wrkr_8081");
                    ...
                    if(takeTime >= receiveTime)
                    {
                        ...
                        ClockWorkerServer.time = ClockWorkerServer.time +differenceTime + 1;
                        ...
                        System.out.println("Updated machine Time : "+ClockWorkerServer.time);
                    }
                    ...
                    try {
                        ...
                        ClockWorkerServer.time = ClockWorkerServer.time + 5;
                    } catch (InterruptedException ex) {
                        //Logger.getLogger(ClockWorkerServerThree.class.getName()).log(Level.SEVERE, null, ex);
                        System.out.println("Sleep time error ");
                    }
            ...
            if (str.equalsIgnoreCase("WORKER")){
                ...
                dosW.writeUTF("Thanks_From_wrkr_8081");
            }
            scW.close();
        } catch (IOException ex) {
